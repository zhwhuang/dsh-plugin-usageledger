/**
 * APICost plugin configuration: defaults, normalization, and URL resolution.
 *
 ...
 *
 * @module dsh-plugin-apicost/config
 */
...
export function resolveConfig(raw) {
  ...
  const providers = Array.isArray(input.trackProviders)
  ...
  return {
    ...
    api: {
      ...
      timeoutMs: integer(api.timeoutMs, 8000, { min: 500, max: 120000 }),
    ...
    platform: {
      ...
      timeoutMs: integer(platform.timeoutMs, 10000, { min: 500, max: 120000 }),
